      ...
      {data && !data.error && (
        <div className="space-y-2">
          ...
          <p className="text-[7px] text-muted-foreground/60 leading-tight">
            ⚠ DISCLAIMER: The information and predictions presented herein are generated by artificial intelligence for general informational and educational purposes only. They do not constitute, and should not be construed as, financial advice, investment recommendations, or an offer or solicitation to buy or sell any securities, commodities, or digital assets. While these insights may support your independent research and decision-making process, they should not be relied upon as the sole basis for any investment decision. Past performance and AI-generated forecasts are not indicative of future results. Always conduct your own due diligence and consult with a qualified, licensed financial advisor before making any investment decisions.
          </p>
        </div>
      )}
    </div>
