    ...
    <div className="absolute inset-0 z-[2000] bg-black flex flex-col">
      ...
      <div className="flex-1 relative" ref={containerRef}>
        ...
        {!showLayerPanel && apiKey && (
          <button onClick={() => setShowLayerPanel(true)} className="absolute top-24 left-3 z-[16] pointer-events-auto flex items-center gap-1 px-2 py-1.5 rounded-md bg-black/80 backdrop-blur border border-primary/30 text-primary hover:bg-primary/15 transition-all" style={{ boxShadow: "0 2px 8px rgba(0,0,0,0.5)" }} title="Open Layer Panel">
