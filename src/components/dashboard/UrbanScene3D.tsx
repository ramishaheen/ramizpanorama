...
export const UrbanScene3D = ({ onClose, initialCoords, initialEvent }: UrbanSceneProps) => {
  ...
  const [opacityWildfires, setOpacityWildfires] = useState(1);
  const vesselMarkersRef = useRef<any[]>([]);
  const earthquakeMarkersRef = useRef<any[]>([]);
  const wildfireMarkersRef = useRef<any[]>([]);
  ...
  // CITY_LANDMARKS_3D imported from ./urban3d/constants
  ...
  return createPortal(
    <div className="fixed inset-0 z-[99999] bg-black flex flex-col">
      ...
      <div className="flex-1 relative" ref={containerRef}>
        ...
        {showZoomIndicator && (
          <div className="absolute bottom-24 left-1/2 -translate-x-1/2 z-[13] pointer-events-none animate-fade-in">
...
// FlightStat, DataRow, LayerControl imported from ./urban3d/LayerControl
