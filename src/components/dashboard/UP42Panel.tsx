...
export const UP42Panel = ({ onFeaturesChange, mapBounds }: UP42PanelProps) => {
  ...
  return (
    <div className="relative">
      ...
      {/* Expanded panel */}
      {expanded && (
        <div className="absolute bottom-full mb-1 left-0 bg-card/95 backdrop-blur-sm border border-border rounded-md p-3 min-w-[280px] max-w-[320px] shadow-xl max-h-[60vh] overflow-y-auto">
