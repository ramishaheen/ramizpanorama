...
export const DEFAULT_IMAGERY_LAYERS: ImageryLayer[] = [
  ...
  {
    id: "modis-aqua-nrt",
    name: "NASA MODIS Aqua NRT",
    shortName: "AQUA",
    url: `https://gibs.earthdata.nasa.gov/wmts/epsg3857/best/MODIS_Aqua_CorrectedReflectance_TrueColor/default/${today}/GoogleMapsCompatible_Level9/{z}/{y}/{x}.jpg`,
    attribution: "&copy; NASA EOSDIS GIBS NRT",
    type: "base",
    opacity: 1,
    enabled: false,
    maxZoom: 9,
  ...
  {
    id: "viirs-snpp-nrt",
    name: "NASA VIIRS SNPP NRT",
    shortName: "VIIRS",
    url: `https://gibs.earthdata.nasa.gov/wmts/epsg3857/best/VIIRS_SNPP_CorrectedReflectance_TrueColor/default/${today}/GoogleMapsCompatible_Level9/{z}/{y}/{x}.jpg`,
    attribution: "&copy; NASA EOSDIS GIBS NRT",
    type: "base",
    opacity: 1,
    enabled: false,
  ...
  {
    id: "viirs-noaa20-nrt",
    name: "NASA VIIRS NOAA-20 NRT",
    shortName: "N20",
    url: `https://gibs.earthdata.nasa.gov/wmts/epsg3857/best/VIIRS_NOAA20_CorrectedReflectance_TrueColor/default/${today}/GoogleMapsCompatible_Level9/{z}/{y}/{x}.jpg`,
    attribution: "&copy; NASA EOSDIS GIBS NRT",
    type: "base",
    opacity: 1,
    enabled: false,
