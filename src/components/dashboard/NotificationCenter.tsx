      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute right-0 top-full mt-2 w-[360px] max-w-[90vw] bg-card/95 backdrop-blur-xl border border-border rounded-lg shadow-2xl z-[2000] overflow-hidden"
          >
            {/* Header */}
